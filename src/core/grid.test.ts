...
describe("createGrid", () => {
  ...
  it("throws if columns have a width less than 1", () => {
    expect(() => createGrid([{ width: 0 }])).throws(
      "Column must be at least 1 wide"
    );
  });

  it("throws if columns have a width more than 12", () => {
    expect(() => createGrid([{ width: 13 }])).throws(
      "Column cannot be more than 12 wide"
    );
  });
...
describe("addColumn", () => {
  ...
  it("throws if the new column's width is less than 1", () => {
    ...
    expect(() => addColumn(grid, input)).throws(
      "Column must be at least 1 wide"
    );
  });
  ...
  it("throws if the new grid cannot provide space for new column", () => {
    ...
    expect(() => addColumn(grid, input)).throws(
      "Cannot provide space for new column"
    );
  });
});
...
describe("popColumn", () => {
  ...
  it("throws if there is only 1 column left", () => {
    const grid = createGrid([{ width: 12, content: "content-a" }]);
